...
@app.post("/api/analyze", response_model=ComparisonReport)
@app.post("/analyze", response_model=ComparisonReport) # Support both
async def analyze_domains(request: AnalysisRequest):
    ...
    comparison = AnalysisEngine.calculate_score # Wait, I need the engine compare
